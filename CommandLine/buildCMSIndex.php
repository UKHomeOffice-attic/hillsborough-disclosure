...
define("CMS_DATA_DIR", 'D:\\builds\\temp\\cms_html\\'); // CMS HTML files
...
//	echo "Processing: ", $file, "\r\n";
	...
	// Set the 'hip_report' flag if the file lives under a /report/ branch of the directory tree
	if (stripos($file, "\\report\\") !== false) {
